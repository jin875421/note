...
import static me.jin.note.constants.Constants.NoteProfile;

public class NoteManager {
    private Context mContext;
    private NoteDBHelper noteDBHelper;
    private SQLiteDatabase database;
    private final String[] TABLE_COLUMNS=new String[]{"id","content","firsttime","lasttime","category","uniqueid","title"};
...
//            SPUtil.putInt(mContext,"noteId",contents.length);
    ...
    public void insert(Note note){
        try {
            ...
            values.put("uniqueid",note.getUniqueId());
    ...
    private Note parseNote(Cursor cursor){//cursor
        ...
        note.setUniqueId(cursor.getString(cursor.getColumnIndex("uniqueid")));
